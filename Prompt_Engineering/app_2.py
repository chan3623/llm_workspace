        ...
        for vid in video_ids:
            ...
            if vid not in seen_ids:
                ...
                try:
                    ...
                    with urllib.request.urlopen(oembed_req, timeout=1.5) as response:
    ...
    for i in range(0, len(music_list), num_cols):
        ...
        for idx, item in enumerate(chunk):
            ...
            with cols[idx]:
                ...
                if st.button("▶ 재생하기", key=btn_key, use_container_width=True):
...
if user_input := st.chat_input("당신의 이야기를 들려주세요..."):
    ...
    with st.chat_message("assistant"):
        ...
        with st.spinner(
            f"🎶 '{search_keyword}' 관련 음악 {requested_count}곡을 검색 중입니다..."
        ):
        ...
        if music_list:
            ...
            st.session_state.current_playing_title = f"#1 {music_list[0]['title']}"
